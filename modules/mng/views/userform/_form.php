    ...
    $(document).ready(function(){
      ...
      //  $( ".inner" ).append( "<p>Test</p>" );
        ...
        $(".card-body").each(function (i) {
            ...
            var href = '/mng/userform/assign-avatar?photo_id=' + id;
            $(this).append("<a href=" + href +
                " class='btn btn-danger avatar'>Назначить аватаром</a>" );
            var href = '/mng/userform/remove-photo?photo_id=' + id;
            $(this).append("<a href=" + href +
...
<div class="userform-form">
    ...
    <?= $form->field($model, 'status')->dropdownList(Userform::getAncetStatus()) ?>

    <?= $form->field($model, 'source')->dropdownList(Userform::getSourceList()) ?>
