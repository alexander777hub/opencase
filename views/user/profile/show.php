            ...
            <div class="col-sm-6 col-md-8">
                ...
                <ul style="padding: 0; list-style: none outside none;">
                    <?php if (!empty($profile->sex)): ?>
                        <li>
                            <i class="glyphicon glyphicon-map-marker text-muted"></i> <?= Html::encode($profile->sexName) ?>
                        </li>
                    <?php endif; ?>
                    <?php if (!empty($profile->birthday)): ?>
                        <li>
                            <i class="glyphicon glyphicon-map-marker text-muted"></i> <?= Html::encode($profile->age) ?>
                        </li>
                    <?php endif; ?>
                    <?php if (!empty($profile->city_id)): ?>
                        <li>
                            <i class="glyphicon glyphicon-map-marker text-muted"></i> <?= Html::encode($profile->cityName) ?>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php endif; ?>
                    <?php if (!empty($profile->vk_link)): ?>
                        <li>
                            <i class="glyphicon glyphicon-globe text-muted"></i> <?= Html::a(Html::encode($profile->vk_link), Html::encode($profile->vk_link)) ?>
                        </li>
                    <?php endif; ?>
