...
\app\assets\DropAsset::register($this);
        ...
        'options' => ['class' => 'navbar-nav mr-auto'], 'items' => [
           ...
           // '<li style="padding-top: 8px">'.LanguageDropdown::widget().'</li>',
            ...
            [
                ...
                'items' => [
                    ['label' => 'Какой то итем ', 'url' => ['/test/test'],  'visible' => !\Yii::$app->user->isGuest],
                   // ['label' => Yii::t('app','Профиль'), 'url' => ['/user/settings/profile'],'visible' => \Yii::$app->user->can(Profile::ROLE_ADMINISTRATOR)],
                   // ['label' => 'Мои свидания', 'url' => ['/cabinet/index'],  'visible' => !\Yii::$app->user->isGuest],
...
//                    ['label' => Yii::t('app', 'Управление блогом'), 'url' => ['/blog/article'], 'visible' => \Yii::$app->user->can('administrator')],
            ...
            [
                ...
                'template' => '<a href="{url}" ><i class="ti-user"></i> {label} <i class="fa fa-angle-down"></i></a>',
                'items' => [
                    ['label' => 'Телефоны', 'url' => ['/phone/index'],  'visible' => \Yii::$app->user->can('administrator')],
                    ['label' => 'Демо ссылки', 'url' => ['/link/index'],  'visible' => \Yii::$app->user->can('administrator')],
            ...
            ['label' => 'Контакты', 'url' => ['/site/contact']],
            ['label' => 'Тест', 'url' =>  ['/test'],'visible' =>   \Yii::$app->user->can(Profile::ROLE_ADMINISTRATOR), ],
...
<footer class="footer mt-auto py-3 text-muted">
    <div class="container">
        <p class="float-left">&copy;Название </p>
    </div>
</footer>
